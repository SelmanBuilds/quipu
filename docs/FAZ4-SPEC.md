...
| **1** | `lib/capture.awk` + `quipu capture` shell döngüsü (§2) + fixture'lar + testler | mevcut 157 iddia aynen yeşil (regresyon yok) + T-50…T-53 |
...
2. **Regresyon kapısı:** mevcut 157 iddia aynen yeşil (Claude Code şeması değişmedi, K-1).
